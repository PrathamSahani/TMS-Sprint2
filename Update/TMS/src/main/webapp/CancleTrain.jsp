...
<head>
  ...
  <title>National Ticket Booking Spot – Cancel Train</title>
  <!-- Bootstrap CSS -->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
  <!-- NAVBAR (exactly your format) -->
  ...
  <div class="container mt-5">
    <h2 class="mb-4">Train Cancellation</h2>
    
    <!-- cancellation form -->
    <form action="admincancletrain" method="post" class="row g-3">
      <div class="col-md-6">
      ...
      <div class="col-md-6 align-self-end">
        <button type="submit" class="btn btn-danger">Cancel Train</button>
      </div>
    </form>
    
    <!-- feedback message -->
    <c:if test="${not empty message}">
      <div class="alert ${message.startsWith('Train number') ? 'alert-success' : 'alert-warning'} mt-4" role="alert">
        ${message}
      </div>
    </c:if>
  </div>
