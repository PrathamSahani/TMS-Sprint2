        ...
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white text-center py-3">
                    <h4 class="mb-1">Card Payment Gateway</h4>
                    <div class="d-flex justify-content-center align-items-center card-icons mt-2">
                        <img src="https://cdn0.iconfinder.com/data/icons/credit-card-debit-card-payment-PNG/128/Mastercard-Curved.png" alt="Mastercard">
                        <img src="https://cdn0.iconfinder.com/data/icons/credit-card-debit-card-payment-PNG/128/Discover-Curved.png" alt="Discover">
                        <img src="https://cdn0.iconfinder.com/data/icons/credit-card-debit-card-payment-PNG/128/Paypal-Curved.png" alt="PayPal">
                        <img src="https://cdn0.iconfinder.com/data/icons/credit-card-debit-card-payment-PNG/128/American-Express-Curved.png" alt="Amex">
                    </div>
                </div>
                <form action="booktrains" method="post">
                    <div class="card-body p-4">
                        <div class="form-floating mb-3">
                            ...
                            <label for="cardNumber"><i class="bi bi-credit-card me-2"></i>Card Number</label>
                        </div>
                        <div class="row g-3">
                            <div class="col-md-6 form-floating">
                                <input type="text" class="form-control" id="expDate" placeholder="MM / YY" required>
                                <label for="expDate"><i class="bi bi-calendar2-event me-2"></i>Expiration Date</label>
                            </div>
                            <div class="col-md-6 form-floating">
                                <input type="text" class="form-control" id="cvc" placeholder="CVC" required>
                                <label for="cvc"><i class="bi bi-lock me-2"></i>CV Code</label>
                            </div>
                        </div>
                        <div class="form-floating mt-3">
                            <input type="text" class="form-control" id="cardOwner" placeholder="Card Owner Name" required>
                            <label for="cardOwner"><i class="bi bi-person me-2"></i>Card Owner</label>
                        </div>
                    </div>
                    <div class="card-footer text-center bg-white py-3">
                        <button type="submit" class="btn btn-success btn-lg w-100 text-bg">Confirm Payment</button>
                    </div>
                </form>
            </div>
        </div>
