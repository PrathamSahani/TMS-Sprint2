...
<head>
  <meta charset="UTF-8">
  <title>Profile - National Ticket Booking Spot</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
  <style>
    body {
      background: url('<%= request.getContextPath() %>/OP.jpeg') no-repeat center center fixed;
...
<body class="d-flex flex-column min-vh-100">
  ...
  <main class="flex-fill">
    <div class="container d-flex flex-column justify-content-center align-items-center" style="margin-top:50px">
      <!-- optional alert -->
    

      <!-- action buttons -->
      <div class='d-flex justify-content-center mb-4 w-100'>
        <a href='${pageContext.request.contextPath}/viewuserprofile' class='btn btn-success mx-2'>View Profile</a>
        <a href='${pageContext.request.contextPath}/edituserprofile' class='btn btn-warning mx-2'>Edit Profile</a>
        <a href='${pageContext.request.contextPath}/changeuserpassword' class='btn btn-primary mx-2'>Change Password</a>
      </div>
        ...
        <div class='col-md-8'>
          <div class='card shadow-sm'>
            <div class='card-body text-center'>
              <h4>Hey ${userName}, welcome to NITRTC!</h4>
