...
<head>
  <meta charset="UTF-8">
  <title>User Login - National Ticket Booking Spot</title>
...
<body class="bg-light">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
      ...
      <div class="d-flex">
        <a class="btn btn-light me-2" href="userlogin">Login as User</a>
      ...
      <div class="card-body">
        ...
        <form action="userlogin" method="post">
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="uname" name="uname" required placeholder="Enter your email">
          </div>
          <div class="mb-3">
